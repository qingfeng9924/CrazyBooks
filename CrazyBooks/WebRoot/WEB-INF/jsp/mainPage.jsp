...
<body>
		...
		<div class="header-top">
			<div class="container">
				...
				<div style="float:right;margin-right: 70px;margin-top: 20px;">
					<form method="post" action="book-findBooksBySomething.action">
				...
				<div class="col-sm-4 header-left">
					...
					<div class="cart box_1">
						...
						<p>
							<a href="ToBookCartJspAction" class="simpleCart_empty">Empty Cart</a>
						</p>
	...
	<div class="banner">
				...
				<dl>
					<s:iterator var="c" value="#session.cList">
						...
						<s:iterator var="ct" value="#c.Categorytwos">
							<dd class="dd1">
								<a
									href="book-findboosByCoid?coid=<s:property value='#ct.id'/>&&page=1"
									class="a2"><s:property value="#ct.name" /></a>
							</dd>
						</s:iterator>
						<br />
						<br />
			...
			<div class="slider">
				<div class="callbacks_container">
					<ul class="rslides" id="slider">
						<li><a href="book-findBooksBySomething.action?search=A"
							id="herfa"><img src="images/1.jpg" id="img"
								style="width: 100%;height: 65%;"></a></li>
					</ul>
					<div style="margin-top: 20px;">
						<!--<marquee direction="left" width="100%;" behavior="scroll" loop="-1">-->
						<ul class="u1">
							<li class="l1"><a href="book-findBookDetail.action?id=5"
								class="a"><img src="images/cover/5.png"
									style="width:100%;height: 100%;border:1px solid #EBEBEB;" /></a></li>
							<li class="l1"><a href="book-findBookDetail.action?id=1"><img
									src="images/cover/1.png"
									style="width:100%;height: 100%;border:1px solid #EBEBEB;" /></a></li>
							<li class="l1"><a href="book-findBookDetail.action?id=2"><img
									src="images/cover/2.png"
									style="width:100%;height: 100%;border:1px solid #EBEBEB;" /></a></li>
							<li class="l1"><a href="book-findBookDetail.action?id=3"><img
		...
		<div class="infoDiv">
			<div id="divdymi">
				<h1>
					<font style="font-family: sans-serif;font-size: 30px;">最新动态</font>
				</h1>
			...
			<div class="divNBInfo">
				<h1>
					<font style="font-family: sans-serif;font-size: 30px;">新书预约</font>
				</h1>
				<hr style="color:black;border-top: 1px black solid;" />
				<div class="bookDiv">
					<a href="#" class="a3"><img src="bookPic/1.jpg"
						style="width:100%;height: 60%;" /> <big>《哆啦A梦》</big> </a><font
						style="color:red;font-size:xx-large;">￥22.00</font><font
						style="font-size:large;color:gray; text-decoration: line-through;">￥52.00</font>
					<p>-------童年经典回忆</p>
				</div>
			</div>
		</div>
	...
	<div class="content">
		<div style="width: 100%;height:100%;">
			<div class="divcontainer">
				&nbsp&nbsp&nbsp&nbsp<font style="font-size: 40px;font-weight: bold;">HOT
					BOOKS</font>
				<hr>
				<div class="content-top1">
					<s:iterator var="bn" value="#session.bhList">
						<div class="col-md-3 col-md2">
							<div class="col-md1 simpleCart_shelfItem">
								<a
									href="book-findBookDetail.action?id=<s:property value='#bn.id'/>">
									<img class="img-responsive"
									src="<s:property value='#bn.picture'/>" alt="" />
								</a>
								<h3>
									<a><s:property value='#bn.name' /></a>
								</h3>
								<div class="price">
									<h5 class="item_price">
										￥
										<s:property value='#bn.price' />
									</h5>
									<a
										href="bookCart-addToCart.action?bid=<s:property value='#bn.id'/>"
