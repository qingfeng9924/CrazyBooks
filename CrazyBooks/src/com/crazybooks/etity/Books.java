...
public class Books implements java.io.Serializable {
	...
	public String toString() {
		return "Books [id=" + id + ", categorytwo=" + categorytwo
				+ ", category=" + category + ", name=" + name + ", picture="
				+ picture + ", intro=" + intro + ", author=" + author
				+ ", pubHouse=" + pubHouse + ", price=" + price + ", state="
				+ state + ", pubDate=" + pubDate + ", btime=" + btime
				+ ", collectionses=" + collectionses + ", borrows=" + borrows
