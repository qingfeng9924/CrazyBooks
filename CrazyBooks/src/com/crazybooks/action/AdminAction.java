...
public class AdminAction extends ActionSupport implements ModelDriven<Managers> {
	...
	//查看所有封禁用户
	public String ViewFreezeUsers(){
		AdminBizImpl adminBizImpl=new AdminBizImpl();
		PageBean<Users> pageBean=adminBizImpl.getFreezeUsers(page);
		HttpServletRequest request=ServletActionContext.getRequest();
		request.setAttribute("freezeusers", pageBean);
		return "ViewFreezeUsers";
	}
